...
DomainErrorTranslator._directories = {
  ...
  'ADDING_THREAD.TITLE_LIMIT_CHAR': new InvariantError(
  ...
  'ADDING_COMMENT.CONTENT_LIMIT_CHAR': new InvariantError(
    'tidak dapat membuat comment karena karakter content melebihi batas limit',
  ),
  ...
  'ADD_REPLY.CONTENT_LIMIT_CHAR': new InvariantError(
    'tidak dapat membuat reply karena karakter content melebihi batas limit',
  ),
};
